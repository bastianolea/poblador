...
pobreza_0 <- read_xlsx("data-raw/sae_ingresos_2024.xlsx", skip = 2) |>
  clean_names()

pobreza_1 <- pobreza_0 |>
  select(
    codigo_comuna = codigo,
    poblacion = numero_de_personas_en_situacion_de_pobreza_de_ingresos
  )
...
mideso_pobreza_ingresos <- pobreza_2 |>
...
usethis::use_data(mideso_pobreza_ingresos, overwrite = TRUE)
