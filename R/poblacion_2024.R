#' Población a nivel comunal de Chile (2024)
#'
#' Cifras de población según el Censo 2024
#'
#' Los datos fueron obtenidos [desde el sitio web del INE](https://censo2024.ine.gob.cl/resultados/).
#'
#'
